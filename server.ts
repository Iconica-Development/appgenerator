...
class RainStatistic {
    constructor(public day: Date, public rainfall: number) {}
}

const rainNorthHolland: RainStatistic[] = [
...
const rainSouthHolland: RainStatistic[] = [
...
const rainZeeland: RainStatistic[] = [
...
const rainUtrecht: RainStatistic[] = [
...
const rainGelderland: RainStatistic[] = [
...
const rainOverijssel: RainStatistic[] = [
...
const rainDrenthe: RainStatistic[] = [
...
const rainFriesland: RainStatistic[] = [
...
const rainGroningen: RainStatistic[] = [
...
const rainNorthBrabant: RainStatistic[] = [
...
const rainLimburg: RainStatistic[] = [
...
const rainFlevoland: RainStatistic[] = [
...
app.get('/rain', (req, res) => {
    ...
    const rainDataMap: Record<string, RainStatistic[]> = {
...
class WeatherData {
    constructor(public actualRainfallMM: number, public predictedRainfallMM: number, public date: Date) {}
}
